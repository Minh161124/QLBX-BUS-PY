# Form implementation generated from reading ui file '6add_qlccvlt.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 691, 671))
...
"font: 10pt \"Swis721 Blk BT\";")
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.calendarWidget_3)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "ADD_CCVLT"))
        self.label.setText(_translate("Dialog", "MANAGEMENT OF ATTENDANCE AND REWARDS"))
        self.label_4.setText(_translate("Dialog", "FUCNTION"))
        self.pushButton_5.setText(_translate("Dialog", "CREATE CONTENT"))
        self.pushButton_6.setText(_translate("Dialog", "VIEW CONTENT"))
        self.label_3.setText(_translate("Dialog", "MCC:"))
        self.label_15.setText(_translate("Dialog", "MNS:"))
        self.label_5.setText(_translate("Dialog", "NCC:"))
        self.label_7.setText(_translate("Dialog", "CALAM:"))
        self.label_6.setText(_translate("Dialog", "TTLV:"))
        self.label_8.setText(_translate("Dialog", "LUONGCB"))
        self.label_9.setText(_translate("Dialog", "SONGAYCONG:"))
        self.label_10.setText(_translate("Dialog", "PHUCAP:"))
        self.label_12.setText(_translate("Dialog", "THUONG:"))
        self.label_13.setText(_translate("Dialog", "PHAT:"))
        self.label_11.setText(_translate("Dialog", "TONGLUONG:"))
