# Form implementation generated from reading ui file '8add_qlpc.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 671, 481))
...
"")
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textEdit_5)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textEdit_8)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.calendarWidget_3)
...
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "ADD_PHÂN CÔNG"))
        self.label.setText(_translate("Dialog", "ASSIGNMENT MANAGEMENT"))
        self.label_4.setText(_translate("Dialog", "FUCNTION"))
        self.pushButton_5.setText(_translate("Dialog", "CREATE ASSIGNMENT"))
        self.pushButton_6.setText(_translate("Dialog", "VIEW ASSIGNMENT"))
        self.label_3.setText(_translate("Dialog", "MPC:"))
        ...
        self.label_6.setText(_translate("Dialog", "VITRI:"))
        self.label_8.setText(_translate("Dialog", "TUYENXE:"))
        self.label_9.setText(_translate("Dialog", "CALAM"))
