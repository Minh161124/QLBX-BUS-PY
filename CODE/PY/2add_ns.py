# Form implementation generated from reading ui file '2add_ns.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 0, 761, 686))
        ...
        self.horizontalLayout_3.setContentsMargins(5, 20, 5, 10)
...
"font: 81 15pt \"Rockwell Extra Bold\";")
        ...
        self.pushButton_5.setMaximumSize(QtCore.QSize(500, 35))
...
"border-color: rgb(120, 120, 120);")
        ...
        self.pushButton_6.setMaximumSize(QtCore.QSize(500, 35))
...
"font: 10pt \"Swis721 Blk BT\";")
        ...
        self.comboBox_2.setStyleSheet("font: 10pt \"Times New Roman\";")
...
"")
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textEdit_10)
        self.label_16 = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        self.label_16.setStyleSheet("font: 10pt \"Swis721 Blk BT\";")
        self.label_16.setObjectName("label_16")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_16)
        self.textEdit_11 = QtWidgets.QTextEdit(parent=self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textEdit_11.sizePolicy().hasHeightForWidth())
        self.textEdit_11.setSizePolicy(sizePolicy)
        self.textEdit_11.setMaximumSize(QtCore.QSize(300, 40))
        self.textEdit_11.setObjectName("textEdit_11")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textEdit_11)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textEdit_7)
        ...
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textEdit_6)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_11)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textEdit_14)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.ItemRole.FieldRole, self.textEdit_13)
        ...
        self.label_17.setStyleSheet("font: 10pt \"Swis721 Blk BT\";")
        self.label_17.setObjectName("label_17")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_17)
        ...
        self.comboBox_3.setCurrentText("Hồ sơ nhân sự")
        ...
        self.comboBox_3.addItem("")
        self.comboBox_3.addItem("")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.ItemRole.FieldRole, self.comboBox_3)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "ADD_NS"))
        self.label.setText(_translate("Dialog", "EMPLOYEE MANAGEMENT"))
        self.label_4.setText(_translate("Dialog", "FUCNTION"))
        self.pushButton_5.setText(_translate("Dialog", "CREATE EMPLOYEER PROFILE"))
        self.pushButton_6.setText(_translate("Dialog", "VIEW EMPLOYEER PROFILE"))
        self.label_3.setText(_translate("Dialog", "MNS:"))
        self.label_15.setText(_translate("Dialog", "USER:"))
        self.label_5.setText(_translate("Dialog", "TENNS:"))
        self.label_7.setText(_translate("Dialog", "NAMSINH:"))
        self.comboBox_2.setItemText(0, _translate("Dialog", "1965"))
        self.comboBox_2.setItemText(1, _translate("Dialog", "1966"))
        self.comboBox_2.setItemText(2, _translate("Dialog", "1967"))
        self.comboBox_2.setItemText(3, _translate("Dialog", "1968"))
        self.comboBox_2.setItemText(4, _translate("Dialog", "1969"))
        self.comboBox_2.setItemText(5, _translate("Dialog", "1970"))
        self.comboBox_2.setItemText(6, _translate("Dialog", "1971"))
        self.comboBox_2.setItemText(7, _translate("Dialog", "1972"))
        self.comboBox_2.setItemText(8, _translate("Dialog", "1973"))
        self.comboBox_2.setItemText(9, _translate("Dialog", "1974"))
        self.comboBox_2.setItemText(10, _translate("Dialog", "1975"))
        self.comboBox_2.setItemText(11, _translate("Dialog", "1975"))
        self.comboBox_2.setItemText(12, _translate("Dialog", "1977"))
        self.comboBox_2.setItemText(13, _translate("Dialog", "1978"))
        self.comboBox_2.setItemText(14, _translate("Dialog", "1979"))
        self.comboBox_2.setItemText(15, _translate("Dialog", "1980"))
        self.comboBox_2.setItemText(16, _translate("Dialog", "1981"))
        self.comboBox_2.setItemText(17, _translate("Dialog", "1982"))
        self.comboBox_2.setItemText(18, _translate("Dialog", "1983"))
        self.comboBox_2.setItemText(19, _translate("Dialog", "1984"))
        self.comboBox_2.setItemText(20, _translate("Dialog", "1985"))
        self.comboBox_2.setItemText(21, _translate("Dialog", "1986"))
        self.comboBox_2.setItemText(22, _translate("Dialog", "1987"))
        self.comboBox_2.setItemText(23, _translate("Dialog", "1988"))
        self.comboBox_2.setItemText(24, _translate("Dialog", "1989"))
        self.comboBox_2.setItemText(25, _translate("Dialog", "1990"))
        self.comboBox_2.setItemText(26, _translate("Dialog", "1991"))
        self.comboBox_2.setItemText(27, _translate("Dialog", "1992"))
        self.comboBox_2.setItemText(28, _translate("Dialog", "1993"))
        self.comboBox_2.setItemText(29, _translate("Dialog", "1994"))
        self.comboBox_2.setItemText(30, _translate("Dialog", "1995"))
        self.comboBox_2.setItemText(31, _translate("Dialog", "1996"))
        self.comboBox_2.setItemText(32, _translate("Dialog", "1997"))
        self.comboBox_2.setItemText(33, _translate("Dialog", "1998"))
        self.comboBox_2.setItemText(34, _translate("Dialog", "1999"))
        self.comboBox_2.setItemText(35, _translate("Dialog", "2000"))
        self.comboBox_2.setItemText(36, _translate("Dialog", "2001"))
        self.comboBox_2.setItemText(37, _translate("Dialog", "2002"))
        self.comboBox_2.setItemText(38, _translate("Dialog", "2003"))
        self.comboBox_2.setItemText(39, _translate("Dialog", "2004"))
        self.comboBox_2.setItemText(40, _translate("Dialog", "2005"))
        self.comboBox_2.setItemText(41, _translate("Dialog", "2006"))
        self.comboBox_2.setItemText(42, _translate("Dialog", "2007"))
        self.comboBox_2.setItemText(43, _translate("Dialog", "2008"))
        self.label_6.setText(_translate("Dialog", "GIOITINH:"))
        self.comboBox.setItemText(0, _translate("Dialog", "Nam"))
        self.comboBox.setItemText(1, _translate("Dialog", "Nữ"))
        self.label_8.setText(_translate("Dialog", "DIACHI:"))
        self.label_16.setText(_translate("Dialog", "SDT:"))
        self.label_12.setText(_translate("Dialog", "LUONG:"))
        self.label_13.setText(_translate("Dialog", "THUONG:"))
        self.label_11.setText(_translate("Dialog", "TRINHDO:"))
        self.label_14.setText(_translate("Dialog", "NSQUANLY:"))
        self.label_9.setText(_translate("Dialog", "PHONGBAN:"))
        self.label_17.setText(_translate("Dialog", "EMAIL:"))
        self.comboBox_3.setItemText(0, _translate("Dialog", "Hồ sơ nhân sự"))
        self.comboBox_3.setItemText(1, _translate("Dialog", "Phân công"))
        self.comboBox_3.setItemText(2, _translate("Dialog", "Chấm công và lương thưởng"))
        self.comboBox_3.setItemText(3, _translate("Dialog", "Hợp đồng lao động"))
        self.comboBox_3.setItemText(4, _translate("Dialog", "Tuyển dụng"))
